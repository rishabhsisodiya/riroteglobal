...
| Memory (Variable Environment) | Code (Thread of Execution) |  |
| --- | --- | --- |
| n= undefined Square:function square{ ..}, square2 = undefined, square4 = undefined After Thread of Execution n= 2 Square:function square{ ..}, square2 = 4, square4 = 6 | It will read line by line 1)var n=2; it will allocate memory n: 2 from n: undefined 2) function square(){} just read function 3) var square2 and var square4 it will create another memory creation process Memory | Code |
| Var ans: undefined var num: undefined | Var num=2 var ans=num*num; var ans= 4 |  |
