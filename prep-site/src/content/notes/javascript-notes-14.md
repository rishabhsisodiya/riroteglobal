...
### So here Throttling is more promising

### 3) Shooting Game Button

**Throttling is more promising** as we need to wait for very small time lets say 100-200ms for our next shot and during that small time we will ignore all button click events
